...
(function (window) {
  ...
  sweDitor.prototype = {
    ...
    _init: function () {
      ...
      // get print id
      this.getPrint = Id("getPrint");
      // The textarea
      this.textArea = Id(this.options.textArea);
      // get clean id
      this.getClean = Id("getClean");
      // get link id
      this.getLink = Id("getLink");
      // get img id
      this.getImg = Id("getImg");
      // get switchbox
      this.quote = Id("quote");
      // get switchbox
      this.switchBox = Id("switchBox");
      // Init Doc function
